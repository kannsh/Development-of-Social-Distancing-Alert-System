...
This project is still under development, in Stage 3.

Stage 1 - Homography Transform of video/image
Stage 2 - Draw transformed points on map
Stage 3 - Measure distance between points
Stage 4 - Sound alarm if distance less than 1 meter
